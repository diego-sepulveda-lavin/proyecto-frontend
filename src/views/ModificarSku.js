                                        ...
                                        <table className="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td className="align-middle text-center">
                                                        <input type="text" className="form-control" placeholder="Descripción" aria-label="Username" aria-describedby="basic-addon1" />
                                                    </td>
                                                    <td className="align-middle text-center">
                                                        <input type="text" className="form-control" aria-describedby="basic-addon1" placeholder="Codigo Barra" disabled />
                                                    </td>
                                                    <td className="align-middle text-center">
                                                        <input type="text" className="form-control" placeholder="Cantidad" aria-label="Username" aria-describedby="basic-addon1" />
                                                    </td>
                                                    <td className="align-middle text-center">
                                                        <input type="text" className="form-control" value="Unidad" aria-label="Username" aria-describedby="basic-addon1" disabled />
                                                    </td>
                                                    <td className="align-middle text-center">
                                                    ...
                                                    <td className="align-middle text-center">
                                                        <input type="text" className="form-control" placeholder="Precio Venta" aria-label="Username" aria-describedby="basic-addon1" />
                                                    </td>
                                                    <td className="align-middle text-center">
