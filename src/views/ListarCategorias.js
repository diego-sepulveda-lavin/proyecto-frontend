                                                    ...
                                                    store.categorias.filter((categoria) => {
                                                        ...
                                                        return (
                                                            <tr key={indice}>
                                                                ...
                                                                <td className="align-middle text-center">
                                                                    <Link to={`/modificar-usuario/${categoria.id}`} type="button" rel="tooltip" title="" className="btn btn-info btn-round btn-icon btn-icon-mini btn-neutral" data-original-title="Editar?">
