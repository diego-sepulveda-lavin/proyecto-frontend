                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="image-container image-left" style={{ "backgroundImage": "url('../assets/img/graficos.jpg')" }}>
                                    ...
                                    <p className="blockquote blockquote-primary">"Con DSHL, me he podido concentrar mucho más en hacer nuevos negocios, ya que gracias a su modulo de ventas y stock, la gestión de mi pyme se ha facilitado muchísimo."
                                            <br />
                                        <br />
                                        <small>-Pedro Machuca, VendoLibros, Temuco</small>
                                    </p>
                                </div>
                            ...
                            <div className="col-md-5">
                                ...
                                <h3>No te quedes en el pasado y dale la oportunidad de crecer a tu negocio</h3>
                                ...
                                <p>Ya no esperes más y déjanos la tarea de llevar esta información por ti. Con DSHL podrás controlar tus ventas, cuadraturas de caja, niveles de stock, proveedores, como además de diversos reportes, los cuales facilitaran la gestión de tu empresa y así permitir que te enfoques en hacer crecer tu negocio.
                                </p>
                            </div>
                        </div>
                    </div>
